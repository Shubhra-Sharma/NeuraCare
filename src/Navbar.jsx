  ...
  return (
    <nav className="navbar">
      ...
      <ul ref={menuRef} className={`nav-links ${menuOpen ? 'active' : ''}`}>
        ...
        <li><Link to="https://neurocare-searcher.streamlit.app/" onClick={() => setMenuOpen(false)}>Find Nearby Hospitals</Link></li>
        <li><Link to="https://dyslexiafriendlyreader-sbwe.streamlit.app/" onClick={() => setMenuOpen(false)}>Dyslexia-Friendly Reader</Link></li>
